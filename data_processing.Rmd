...
```
---
title: 'An Analysis Report of Health and Economic Impact by Severe Weather Events - Based on NOAA Storm Database'
...
---
# Synopsis
Some bla-bla-bla text here

# Data processing.
## Environment and development info

Before loading the data i initialise neccesary packages and get my environment info.
```{r}
#load dependencies
library(R.utils)
library(ggplot2)
...
Aggregating prepared data by type of event.
```{r}
#aggregate the data
...
1. **Flood** affect most property damage in the USA - 155 Billions of USD.
2. **Drought** affect most crop damage in the USA - 14 Billions of USD.